---
title: Claude Code
description: Claude Code configuration guide — use Anthropic's terminal-based coding agent with FlyReq API. Supports code understanding, multi-file editing, and IDE integration.
---
...
```powershell
iex (irm 'https://raw.githubusercontent.com/QuantumNous/flyreqapi-docs/refs/heads/main/helper/claude-cli-setup.ps1')
```
...
<Callout type="info" title="One-Click Setup for Claude Code Environment Variables">
  ...
  ```bash
  curl -fsSL https://raw.githubusercontent.com/QuantumNous/flyreqapi-docs/refs/heads/main/helper/claude-cli-setup.sh | bash
  ```
</Callout>
